...
# 220 real, individually famous archaeological artifacts focusing on regions
# under-represented elsewhere in the collection: Southeast Asia, Korea,
# Central Asia/Silk Road, Africa beyond Egypt, Pacific/Oceania beyond Easter
# Island Moai, Andean/Mesoamerican beyond the most obvious pieces, and the
# Middle East beyond the most obvious Egyptian material.
MORE_ARCHAEOLOGY_BATCH2 = [
    # --- Southeast Asia: Vietnam, Thailand, Cambodia, Philippines, Indonesia, Myanmar ---
    ("Dong Son Bronze Drum", "Dong Son drum", "Dong Son culture", "c. 600 BC - 200 AD", "Vietnam", "Elaborately decorated bronze ceremonial drums produced by the Dong Son culture, among the most sophisticated bronze-age artifacts of Southeast Asia."),
    ("Ngoc Lu Bronze Drum", "Ngọc Lũ drum", "Dong Son culture", "c. 3rd-2nd century BC", "Vietnam", "The most celebrated of the surviving Dong Son drums, prized for its intricately engraved scenes of boats, houses, and birds."),
    ("Emerald Buddha", "Emerald Buddha", "Unknown Lanna artisans", "c. 15th century", "Thailand", "A small, revered jadeite Buddha image housed at Wat Phra Kaew in Bangkok and regarded as the palladium of the Thai kingdom."),
    ("Sukhothai Walking Buddha", "Walking Buddha", "Sukhothai Kingdom artisans", "13th-14th century", "Thailand", "A graceful bronze Buddha type originated in the Sukhothai period, celebrated for pioneering the depiction of the Buddha in mid-stride."),
    ("Manunggul Jar", "Manunggul Jar", "Unknown (Late Neolithic Philippines)", "c. 890-710 BC", "Philippines", "A secondary burial jar whose lid features two figures paddling a boat of the dead, considered a masterpiece of pre-colonial Philippine pottery."),
    ("Golden Tara of Agusan", "Golden Tara", "Unknown (pre-colonial Philippines)", "c. 9th-10th century", "Philippines", "A gold statuette of a Hindu-Buddhist female deity found in Mindanao, evidence of early Indianized trade contact in the Philippines."),
    ("Ifugao Bulul Rice Guardian", "Bulul", "Ifugao people", "Traditional (centuries-old practice)", "Philippines", "Carved wooden guardian figures placed in Ifugao rice granaries to protect and bless the harvest."),
    ("Angono Petroglyphs", "Angono Petroglyphs", "Unknown (prehistoric Philippines)", "c. 3000 BC", "Philippines", "The oldest known work of art in the Philippines, comprising 127 human and animal figures engraved into a rock shelter wall."),
    ("Wonoboyo Gold Hoard", "Wonoboyo hoard", "Mataram Kingdom", "9th-10th century", "Indonesia", "A hoard of gold jewelry, vessels, and coins unearthed in Central Java, showcasing the refined goldsmithing of ancient Java."),
    ("Borobudur Ship Relief", "Borobudur ship", "Sailendra dynasty", "c. 800 AD", "Indonesia", "A bas-relief carved into the Borobudur temple depicting an outrigger sailing vessel, evidence of ancient Javanese maritime trade routes."),
    ("Mahamuni Buddha Image", "Mahamuni Buddha", "Unknown (traditionally Rakhine origin)", "Traditionally cast 1st century AD; installed 1784", "Myanmar", "A revered bronze Buddha image enshrined in Mandalay, believed by tradition to be a life-cast likeness of the Buddha himself."),
    ("Terrace of the Leper King Statue", "Terrace of the Leper King", "Khmer Empire", "late 12th century", "Cambodia", "A moss-covered stone statue at Angkor, traditionally identified with the Hindu god of death Yama or a leprous king from Khmer legend."),
    ("Churning of the Ocean of Milk Bas-Relief", "Churning of the Ocean of Milk", "Khmer Empire", "early 12th century", "Cambodia", "A vast bas-relief carved along the outer gallery of Angkor Wat depicting gods and demons churning the cosmic sea for the elixir of immortality."),
    ("Southeast Asian Kris Dagger", "Kris", "Various Austronesian smiths", "Documented since c. 9th century", "Indonesia/Malay Archipelago", "A distinctive asymmetrical dagger with a wavy blade, forged through a layered pamor technique and imbued with spiritual significance."),
    ("Sa Huynh Culture Jar Burials", "Sa Huỳnh culture", "Sa Huỳnh culture", "c. 1000 BC - 200 AD", "Vietnam", "An Iron Age culture of coastal Vietnam known for distinctive lidded burial jars and nephrite ear ornaments traded across maritime Southeast Asia."),
    ("Bust of Jayavarman VII", "Jayavarman VII", "Khmer Empire", "late 12th century", "Cambodia", "A serenely smiling sandstone portrait head, one of the most recognizable royal likenesses to survive from the Angkorian era."),
    ("Phra Phuttha Chinnarat", "Phra Phuttha Chinnarat", "Sukhothai Kingdom artisans", "1357", "Thailand", "A celebrated bronze Buddha image in Phitsanulok regarded as one of the most beautiful Buddha statues in Thailand."),
    ("Ban Chiang Painted Pottery", "Ban Chiang", "Unknown (prehistoric Thailand)", "c. 2100 BC - 200 AD", "Thailand", "A UNESCO-listed prehistoric site famed for its red-on-buff painted whorl-patterned earthenware, evidence of an early Southeast Asian farming culture."),
    ("Statue Identified as Ken Dedes (Prajnaparamita)", "Ken Dedes", "Singhasari Kingdom", "late 13th century", "Indonesia", "An elegant stone statue of the goddess of transcendent wisdom, believed to be an idealized portrait of a legendary Javanese queen."),
    ("Tra Kieu Dancer Relief", "Champa", "Champa Kingdom", "c. 10th century", "Vietnam", "A sandstone pedestal relief of a celestial dancer from the Cham capital of Tra Kieu, among the finest examples of Cham sculpture."),
    ("Trowulan Terracotta and Bronze Finds", "Trowulan", "Majapahit Empire", "13th-15th century", "Indonesia", "The ruined capital of the Majapahit Empire, which has yielded extensive terracotta figurines, bronzeware, and gold artifacts."),
    ("Pyu Silver and Gold Reliquaries", "Pyu city-states", "Pyu city-states", "c. 2nd century BC - 11th century AD", "Myanmar", "Early Buddhist urban civilizations of the Irrawaddy valley whose burial sites have yielded silver and gold reliquaries and inscribed artifacts."),
    ("Colossal Buddhas of Ananda Temple", "Ananda Temple", "Kingdom of Pagan", "1105", "Myanmar", "A Bagan temple renowned for its four towering gilded standing Buddha images facing the cardinal directions."),
    ("Dvaravati Dharmachakra Stone Wheel", "Dharmachakra", "Dvaravati Kingdom", "c. 7th-9th century", "Thailand", "Large stone wheels of the law erected on pillars by the Mon Dvaravati culture, among the earliest Buddhist monuments of mainland Southeast Asia."),
    ("Bronze Reclining Vishnu of West Mebon", "West Mebon", "Khmer Empire", "11th century", "Cambodia", "The fragmentary remains of a colossal bronze reclining Vishnu, once among the largest bronze castings of the ancient world."),
    ("Balangay Plank Boats", "Balangay", "Unknown (early Philippine seafarers)", "c. 320 AD onward", "Philippines", "Ancient lashed-lug plank boats excavated in Butuan, the oldest watercraft found in the Philippines and evidence of early maritime trade."),
    ("Sangiran Early Human Fossils", "Sangiran", "Unknown (Homo erectus site)", "c. 1.5 million - 250,000 years ago", "Indonesia", "A rich paleoanthropological site on Java that has yielded some of the world's most important Homo erectus fossil remains."),
    ("Liang Bua Hobbit Remains", "Liang Bua", "Unknown (Homo floresiensis site)", "c. 60,000-100,000 years ago", "Indonesia", "A limestone cave on Flores where the remains of the diminutive hominin species Homo floresiensis were discovered in 2003."),
    ("Tabon Caves Human Remains", "Tabon Caves", "Unknown (prehistoric Philippines)", "c. 47,000 years ago", "Philippines", "A complex of caves on Palawan that yielded the Tabon Man fossils, among the oldest human remains found in the Philippines."),
    ("Oc Eo Trade Artifacts", "Óc Eo", "Funan Kingdom", "1st-7th century AD", "Vietnam", "An ancient port city of the Funan kingdom that yielded Roman coins, Indian seals, and Chinese mirrors attesting to its role in early maritime Silk Road trade."),

    # --- Korea ---
    ("Gold Crowns of Silla", "Gold crowns of Silla", "Silla Kingdom", "5th-6th century", "Korea", "Ornate gold crowns adorned with tree- and antler-shaped uprights and jade jewels, buried with Silla royalty in the Gyeongju tumuli."),
    ("Cheonmado (Painting of a Heavenly Horse)", "Cheonmado", "Silla Kingdom", "5th-6th century", "Korea", "A painting of a white horse rendered on a birch-bark saddle flap, the earliest known Korean painting, recovered from the Cheonmachong tomb."),
    ("Gilt-bronze Incense Burner of Baekje", "Gilt-bronze Incense Burner of Baekje", "Baekje Kingdom", "late 6th century", "Korea", "An elaborately cast incense burner topped with a phoenix, regarded as one of the finest masterpieces of ancient Korean metalwork."),
    ("Pensive Bodhisattva", "Pensive Bodhisattva", "Three Kingdoms of Korea", "late 6th-early 7th century", "Korea", "A serene gilt-bronze Maitreya figure seated in contemplation, among the most celebrated works of early Korean Buddhist sculpture."),
    ("Goryeo Celadon Ware", "Goryeo celadon", "Goryeo Dynasty", "10th-14th century", "Korea", "Jade-green glazed ceramics prized for their subtle color and inlaid sanggam decoration, considered a pinnacle of Korean ceramic art."),
    ("Buncheong Ware", "Buncheong", "Joseon Dynasty", "15th-16th century", "Korea", "Grayish-blue stoneware coated with white slip and decorated with stamped or brushed patterns, a distinctive Korean successor to celadon."),
    ("Tripitaka Koreana", "Tripitaka Koreana", "Goryeo Dynasty", "1236-1251", "Korea", "A complete Buddhist canon carved onto over 81,000 wooden printing blocks, preserved at Haeinsa temple as a UNESCO World Heritage artifact."),
    ("Divine Bell of King Seongdeok", "Divine Bell of King Seongdeok", "Silla Kingdom", "771", "Korea", "The largest surviving bronze bell from ancient Korea, famed for its resonant tone and finely cast decorative reliefs."),
    ("Goguryeo Tomb Murals", "Complex of Koguryo Tombs", "Goguryeo Kingdom", "4th-7th century", "Korea/China border region", "A group of richly painted royal and noble tomb chambers whose murals depict daily life, mythology, and the Four Guardian Spirits."),
    ("Tomb of King Muryeong", "Tomb of King Muryeong", "Baekje Kingdom", "525 AD", "Korea", "The only securely identified royal tomb of the Baekje kingdom, yielding gold crown ornaments, jewelry, and bronze mirrors untouched by looters."),
    ("Cheonmachong (Heavenly Horse Tomb)", "Cheonmachong", "Silla Kingdom", "5th-6th century", "Korea", "A Silla royal tumulus in Gyeongju that yielded a gold crown, saddle ornaments, and the famed Cheonmado painting."),
    ("Bangudae Petroglyphs", "Bangudae", "Unknown (prehistoric Korea)", "c. 6000-1000 BC", "Korea", "A riverside cliff face densely carved with images of whales, land animals, and hunters, among the oldest known depictions of whaling."),
    ("Gochang, Hwasun and Ganghwa Dolmen Sites", "Gochang, Hwasun and Ganghwa Dolmen Sites", "Unknown (Korean Bronze Age)", "c. 1000-300 BC", "Korea", "The densest concentration of megalithic dolmens in the world, marking the burial sites of Korea's Bronze Age elite."),
    ("Hwangnamdaechong Tomb Treasures", "Hwangnamdaechong", "Silla Kingdom", "5th century", "Korea", "A large double-mound royal tomb in Gyeongju that yielded gold crowns, belts, and thousands of glass and jade ornaments."),
    ("Amsa-dong Neolithic Settlement", "Amsa-dong", "Unknown (Korean Neolithic)", "c. 4000-3000 BC", "Korea", "A well-preserved Neolithic pit-house settlement on the Han River known for its comb-pattern Jeulmun pottery."),
    ("Jeulmun Comb-Pattern Pottery", "Jeulmun pottery", "Unknown (Korean Neolithic)", "c. 8000-1500 BC", "Korea", "Distinctive incised comb-pattern pottery that defines Korea's Neolithic period and gives the era its name."),
    ("Mumun Plain Pottery", "Mumun pottery period", "Unknown (Korean Bronze Age)", "c. 1500-300 BC", "Korea", "Undecorated utilitarian pottery characteristic of Korea's Bronze Age farming societies, found alongside dolmens and bronze daggers."),
    ("Gaya Iron Armor and Weapons", "Gaya confederacy", "Gaya confederacy", "1st-6th century AD", "Korea", "A confederation of small city-states renowned for advanced ironworking, whose tombs have yielded elaborate iron armor and horse trappings."),
    ("Seokguram Grotto Buddha", "Seokguram", "Silla Kingdom", "8th century", "Korea", "A monumental granite Buddha enshrined in an artificial grotto overlooking the sea, considered a masterpiece of East Asian Buddhist sculpture."),
    ("Dabotap Pagoda", "Dabotap", "Silla Kingdom", "751 AD", "Korea", "An intricately carved stone pagoda at Bulguksa temple, celebrated for its unusual and ornate multi-tiered design."),
    ("Seokgatap Pagoda", "Seokgatap", "Silla Kingdom", "751 AD", "Korea", "A simple, elegantly proportioned three-story stone pagoda at Bulguksa temple, within which the world's oldest surviving woodblock print was found."),
    ("Cheomseongdae Observatory", "Cheomseongdae", "Silla Kingdom", "7th century", "Korea", "A bottle-shaped stone tower in Gyeongju regarded as the oldest surviving astronomical observatory in East Asia."),

    # --- Central Asia and the Silk Road: Kazakhstan, Uzbekistan, Mongolia ---
    ("Golden Man of Issyk Kurgan", "Golden Man", "Saka culture", "c. 5th-4th century BC", "Kazakhstan", "A Saka-Scythian warrior burial suit covered in thousands of gold plaques, one of Central Asia's most iconic archaeological finds."),
    ("Issyk Kurgan", "Issyk kurgan", "Saka culture", "c. 5th-4th century BC", "Kazakhstan", "A Saka royal burial mound near Almaty that yielded the famous gold-suited 'Golden Man' along with a silver bowl bearing an undeciphered script."),
    ("Berel Kurgan Frozen Tombs", "Berel kurgan", "Saka culture", "c. 3rd century BC", "Kazakhstan", "Frozen elite Saka burial mounds in the Altai Mountains that preserved elaborately decorated horses and gold-covered wooden artifacts."),
    ("Bactrian Gold (Tillya Tepe Hoard)", "Tillya Tepe", "Bactrian/Kushan-era nomads", "1st century BC - 1st century AD", "Afghanistan/Central Asia", "A hoard of more than 20,000 gold ornaments recovered from six nomadic burial mounds, among the richest archaeological finds of Central Asia."),
    ("Pectoral of Tovsta Mohyla", "Pectoral of Tovsta Mohyla", "Scythian culture", "4th century BC", "Ukraine/Central Asian steppe", "An elaborately worked gold pectoral depicting Scythian nomadic life, considered a masterpiece of ancient steppe goldsmithing."),
    ("Pazyryk Carpet", "Pazyryk carpet", "Pazyryk culture", "c. 5th century BC", "Central Asia/Siberian Altai", "The oldest known surviving pile carpet, preserved in permafrost in a Scythian-era burial mound in the Altai Mountains."),
    ("Siberian Ice Maiden (Princess of Ukok)", "Siberian Ice Maiden", "Pazyryk culture", "c. 5th century BC", "Central Asia/Siberian Altai", "A remarkably preserved frozen mummy of a young Pazyryk woman, found with elaborate tattoos, textiles, and grave goods on the Ukok Plateau."),
    ("Oxus Treasure", "Oxus treasure", "Achaemenid Persian Empire", "5th-4th century BC", "Central Asia (Amu Darya region)", "A hoard of gold and silver votive objects and coins recovered near the Oxus River, among the richest surviving collections of Achaemenid metalwork."),
    ("Afrasiyab Sogdian Murals", "Afrasiyab, Samarkand", "Sogdian civilization", "7th century AD", "Uzbekistan", "Vividly painted palace murals depicting foreign embassies and court life, discovered at the ancient site of Samarkand."),
    ("Noin-Ula Burial Mounds", "Noin-Ula burial site", "Xiongnu Empire", "1st century BC - 1st century AD", "Mongolia", "Elite Xiongnu tombs that yielded finely woven wool textiles, lacquerware, and embroidered felt hangings depicting mythical beasts."),
    ("Mongolian Deer Stones", "Deer stone", "Bronze Age steppe cultures", "c. 1400-700 BC", "Mongolia", "Upright stone monuments carved with stylized flying deer, thought to mark elite burials across the Mongolian and Siberian steppe."),
    ("Khirgisuur Burial Mounds", "Khirgisuur", "Bronze Age Mongolian cultures", "c. 3rd-1st millennium BC", "Mongolia", "Large stone mound monuments surrounded by circular fences and satellite burials, among the most numerous archaeological features of the Mongolian steppe."),
    ("Orkhon Inscriptions", "Orkhon inscriptions", "Second Turkic Khaganate", "732-735 AD", "Mongolia", "Monumental stone inscriptions in the early Turkic runic script, among the oldest surviving texts of a Turkic language."),
    ("Memorial Complex of Bilge Khagan", "Bilge Qaghan", "Second Turkic Khaganate", "8th century AD", "Mongolia", "A memorial complex and inscribed stele honoring a Turkic khagan, part of the celebrated Orkhon monument group."),
    ("Varakhsha Palace Murals", "Varakhsha", "Sogdian civilization", "6th-8th century AD", "Uzbekistan", "The ruins of a pre-Islamic Bukhar-Khudah palace whose walls preserved vivid murals of hunting scenes and mythical creatures."),
    ("Fayaz Tepe Buddhist Complex", "Fayaz Tepe", "Kushan Empire", "1st-3rd century AD", "Uzbekistan", "A Kushan-era Buddhist monastery complex that yielded stucco sculptures and a rare depiction of the Buddha flanked by donors."),
    ("Dalverzin-tepe Kushan Treasures", "Dalverzin-tepe", "Kushan Empire", "1st-2nd century AD", "Uzbekistan", "An ancient Kushan city whose ruins yielded a gold hoard and monumental Buddhist and dynastic sculpture."),
    ("Toprak-Kala Palace Complex", "Toprak-Kala", "Khwarezmian civilization", "1st-4th century AD", "Uzbekistan", "The fortified capital of ancient Khwarezm, notable for its monumental palace adorned with painted and sculpted clay figures."),
    ("Besshatyr Royal Kurgans", "Besshatyr", "Saka culture", "7th-6th century BC", "Kazakhstan", "A cemetery of monumental Saka royal burial mounds in the Ili Valley, among the earliest large-scale Saka funerary monuments."),
    ("Karasuk Culture Bronzes", "Karasuk culture", "Karasuk culture", "c. 1500-800 BC", "Central Asia/Southern Siberia", "A late Bronze Age culture of the Eurasian steppe known for distinctive curved bronze knives and horse-head-decorated artifacts."),
    ("Andronovo Culture Chariot Burials", "Andronovo culture", "Andronovo culture", "c. 2000-900 BC", "Kazakhstan/Central Asia", "A widespread Bronze Age culture of the Central Asian steppe credited with some of the earliest known spoke-wheeled chariot burials."),

    # --- Africa beyond Egypt: Nubia/Sudan, Great Zimbabwe/Southern Africa, Mali, Ethiopia, Nigeria, Ghana ---
    ("Pyramids of Meroe", "Pyramids of Meroë", "Kingdom of Kush", "c. 300 BC - 300 AD", "Sudan", "Steep-sided royal pyramids of the Kushite kingdom, more numerous than those of Egypt though smaller in scale."),
    ("Meroe Head of Augustus", "Meroë Head", "Kushite/Roman workshop", "c. 27-25 BC", "Sudan", "A bronze portrait head of Emperor Augustus looted from Roman Egypt by Kushite raiders and buried beneath a temple threshold in triumph."),
    ("Jebel Barkal Temple Complex", "Jebel Barkal", "Kingdom of Kush", "c. 1500 BC - 300 AD", "Sudan", "A sacred mountain and temple complex regarded by both Egyptians and Kushites as the dwelling place of the god Amun."),
    ("Kerma Culture Black-Topped Pottery", "Kerma culture", "Kerma culture", "c. 2500-1500 BC", "Sudan", "One of Africa's earliest urban civilizations south of Egypt, celebrated for its exceptionally thin, polished black-topped ceramic beakers."),
    ("Napata Royal Necropolis", "Napata", "Kingdom of Kush", "c. 800-270 BC", "Sudan", "The early capital and royal burial ground of the Kushite kings, seat of the 25th Dynasty 'Black Pharaohs' of Egypt."),
    ("Nubian Pyramids", "Nubian pyramids", "Kingdom of Kush", "c. 800 BC - 350 AD", "Sudan", "More than 200 steep royal pyramids built by the rulers of Kush, forming the largest concentration of pyramids anywhere in the world."),
    ("Lion Temple of Naqa", "Naqa", "Kingdom of Kush", "1st century AD", "Sudan", "A well-preserved Kushite temple complex dedicated to the lion-god Apedemak, decorated with reliefs of Kushite royalty."),
    ("Musawwarat es-Sufra Temple Complex", "Musawwarat es-Sufra", "Kingdom of Kush", "3rd century BC", "Sudan", "A vast Kushite religious complex known for its elephant reliefs and enigmatic 'Great Enclosure' of interconnected courtyards."),
    ("Semna Forts", "Semna, Sudan", "Middle Kingdom Egypt/Kushite successors", "c. 1900 BC", "Sudan", "A chain of fortresses built to control Nile trade and mark Egypt's southern Nubian frontier, later reused by Kushite rulers."),
    ("Faras Cathedral Murals", "Faras", "Christian Nubian kingdom of Makuria", "8th-12th century AD", "Sudan", "A Nubian cathedral whose walls preserved a vivid gallery of Christian frescoes, now divided between museums in Khartoum and Warsaw."),
    ("Zimbabwe Bird Soapstone Sculptures", "Zimbabwe Bird", "Kingdom of Zimbabwe", "c. 1200-1450 AD", "Zimbabwe", "Carved soapstone birds perched atop monoliths at Great Zimbabwe, now a national symbol of Zimbabwe."),
    ("Golden Rhinoceros of Mapungubwe", "Golden Rhinoceros of Mapungubwe", "Kingdom of Mapungubwe", "c. 1220-1290 AD", "South Africa", "A small gold-foil-covered wooden rhinoceros buried with a royal figure, symbolizing one of southern Africa's earliest known kingdoms."),
    ("Blombos Cave Engraved Ochre", "Blombos Cave", "Middle Stone Age humans", "c. 75,000-100,000 years ago", "South Africa", "A coastal cave that yielded deliberately engraved pieces of ochre, among the earliest known evidence of symbolic human behavior."),
    ("Lydenburg Heads", "Lydenburg Heads", "Unknown (Early Iron Age)", "c. 500-700 AD", "South Africa", "Seven ceramic head sculptures, among the earliest known figurative art from sub-Saharan Africa's Iron Age."),
    ("Khami Ruins", "Khami", "Kingdom of Butua", "15th-17th century AD", "Zimbabwe", "The stone-walled capital of the Torwa dynasty, successor state to Great Zimbabwe, known for its decorated dry-stone terraces."),
    ("Thulamela Golden Artifacts", "Thulamela", "Late Iron Age Venda-Shona polity", "15th-17th century AD", "South Africa", "A stone-walled hilltop settlement in Kruger National Park whose royal burials yielded gold jewelry linked to Great Zimbabwe trade networks."),
    ("Twyfelfontein Rock Engravings", "Twyfelfontein", "San (Bushmen) hunter-gatherers", "c. 2000 BC - 1000 AD", "Namibia", "One of the largest concentrations of rock petroglyphs in Africa, depicting animals, footprints, and abstract motifs."),
    ("San Rock Art of the Drakensberg", "San rock art", "San (Bushmen) hunter-gatherers", "c. 2000 BC - 19th century AD", "Southern Africa", "Thousands of painted rock shelters depicting eland, human figures, and shamanistic trance imagery across southern Africa."),
    ("Djenne-Djenno Terracotta Statuettes", "Djenné-Djenno", "Djenné-Djenno culture", "c. 250 BC - 1400 AD", "Mali", "One of sub-Saharan Africa's oldest known cities, famed for its expressive terracotta figures of humans and animals."),
    ("Bandiagara Escarpment (Dogon Country)", "Bandiagara Escarpment", "Dogon people (and Tellem predecessors)", "c. 11th century AD onward", "Mali", "A dramatic sandstone cliff settled successively by the Tellem and Dogon peoples, renowned for cliffside granaries and carved wooden doors."),
    ("Tellem Cliff Dwellings", "Tellem", "Tellem culture", "c. 11th-16th century AD", "Mali", "A cliff-dwelling culture that preceded the Dogon in the Bandiagara Escarpment, leaving behind granaries, textiles, and burial caves."),
    ("Tomb of Askia", "Tomb of Askia", "Songhai Empire", "1495 AD", "Mali", "A 17-meter earthen pyramid mausoleum built for Askia Mohammad I, ruler of the Songhai Empire, in the ancient city of Gao."),
    ("Obelisk of Axum", "Obelisk of Axum", "Kingdom of Aksum", "c. 4th century AD", "Ethiopia", "A towering carved granite stele marking a royal tomb, looted to Rome in 1937 and repatriated to Ethiopia in 2005."),
    ("Aksumite Coinage", "Aksumite currency", "Kingdom of Aksum", "3rd-7th century AD", "Ethiopia", "Gold, silver, and bronze coins minted by the Kingdom of Aksum, the first sub-Saharan African civilization to strike its own currency."),
    ("Ezana Stone", "Ezana Stone", "Kingdom of Aksum", "4th century AD", "Ethiopia", "A trilingual royal inscription of King Ezana of Aksum, comparable in historical significance to Egypt's Rosetta Stone."),
    ("Lucy (Australopithecus afarensis)", "Lucy (Australopithecus)", "Unknown (early hominin fossil)", "c. 3.2 million years ago", "Ethiopia", "A remarkably complete fossil skeleton of an early hominin species, one of the most significant discoveries in human evolutionary science."),
    ("Omo Kibish Fossils", "Omo remains", "Unknown (early Homo sapiens fossils)", "c. 233,000 years ago", "Ethiopia", "Among the oldest known fossils of anatomically modern humans, discovered along the Omo River in southern Ethiopia."),
    ("Yeha Temple", "Yeha", "Sabaean-influenced Dʿmt kingdom", "c. 8th-7th century BC", "Ethiopia", "The oldest standing structure in Ethiopia, a monumental temple showing strong architectural links to ancient South Arabia."),
    ("Benin Bronzes", "Benin Bronzes", "Kingdom of Benin", "13th-16th century AD onward", "Nigeria", "Intricately cast brass and bronze plaques and sculptures that adorned the royal palace of the Oba of Benin."),
    ("Ivory Mask of Queen Idia", "Idia", "Kingdom of Benin", "early 16th century", "Nigeria", "A finely carved ivory pendant mask representing the Queen Mother Idia, worn by the Oba of Benin during ceremonial rites."),
    ("Bronze Head from Ife", "Bronze Head from Ife", "Kingdom of Ife", "12th-15th century AD", "Nigeria", "A naturalistic cast bronze head from the Yoruba city of Ife, celebrated worldwide for its extraordinary sculptural realism."),
    ("Ori Olokun Head", "Ori Olokun", "Kingdom of Ife", "12th-15th century AD", "Nigeria", "A famed Ife bronze head named for the sea deity Olokun, among the most widely reproduced images of African classical art."),
    ("Nok Terracotta Figures", "Nok culture", "Nok culture", "c. 1500 BC - 500 AD", "Nigeria", "One of the earliest known sub-Saharan African sculptural traditions, producing distinctive life-sized terracotta human and animal figures."),
    ("Igbo-Ukwu Bronzes", "Igbo-Ukwu", "Igbo-Ukwu culture", "c. 9th century AD", "Nigeria", "Elaborately decorated leaded-bronze ritual vessels and regalia, among the earliest and most technically sophisticated metalwork in West Africa."),
    ("Opa Oranmiyan (Staff of Oranmiyan)", "Opa Oranmiyan", "Kingdom of Ife", "c. 12th century AD", "Nigeria", "A tall granite monolith in Ile-Ife traditionally associated with the legendary founder-king Oranmiyan."),
    ("Esie Soapstone Figures", "Esie", "Unknown (pre-Yoruba)", "c. 12th-15th century AD (disputed)", "Nigeria", "A collection of over 800 carved soapstone figures of unknown origin found at Esie, the largest such assemblage in West Africa."),
    ("Tsoede Bronzes", "Tsoede", "Nupe Kingdom", "c. 14th-16th century AD", "Nigeria", "A group of cast bronze figures associated with the legendary founder of the Nupe kingdom, linked stylistically to Igbo-Ukwu and Benin traditions."),
    ("Akan Gold Weights", "Akan goldweights", "Akan peoples (Ashanti)", "15th-19th century AD", "Ghana", "Small cast brass weights used to measure gold dust, decorated with proverbs and figures reflecting Akan philosophy and daily life."),
    ("Golden Stool of the Ashanti", "Golden Stool", "Ashanti Empire", "c. 1700 AD", "Ghana", "The sacred royal stool believed to house the soul of the Ashanti nation, central to Ashanti kingship and spiritual identity."),
    ("Komaland Terracotta Figurines", "Komaland", "Koma culture", "c. 700-1400 AD", "Ghana", "An enigmatic corpus of small terracotta figurines unearthed in northern Ghana, evidence of a little-understood ancient farming culture."),

    # --- Pacific/Oceania beyond the Easter Island Moai ---
    ("Hawaiian Feather Cloak ('Ahu 'ula)", "ʻAhu ʻula", "Native Hawaiian featherworkers", "18th century", "Hawaii (United States)", "A cloak woven from thousands of tiny bird feathers, worn by Hawaiian chiefs as a mark of the highest rank and sacred power."),
    ("Kukailimoku Feather War God Image", "Kūkaʻilimoku", "Native Hawaiian featherworkers", "18th century", "Hawaii (United States)", "A woven and feathered image of the Hawaiian war god, carried into battle by King Kamehameha I."),
    ("Maori Pounamu Greenstone Carvings", "Pounamu", "Māori", "Traditional (pre-19th century onward)", "New Zealand", "Sacred nephrite jade carved by Māori artisans into ornaments, tools, and weapons imbued with ancestral mana."),
    ("Hei-tiki Pendant", "Hei-tiki", "Māori", "Traditional (pre-19th century onward)", "New Zealand", "A carved greenstone pendant in human form, worn as a treasured heirloom passed down through Māori generations."),
    ("Te Toki a Tapiri War Canoe", "Te Toki a Tāpiri", "Māori", "c. 1836", "New Zealand", "The last surviving large Māori war canoe (waka taua), intricately carved and now preserved at the Auckland War Memorial Museum."),
    ("Hotunui Carved Meeting House", "Hotunui", "Māori (Ngāti Awa)", "1878", "New Zealand", "A finely carved Māori meeting house whose ancestral carvings exemplify 19th-century Māori architectural artistry."),
    ("Lapita Pottery", "Lapita culture", "Lapita culture", "c. 1600-500 BC", "Pacific Islands (Melanesia/Polynesia)", "Distinctively dentate-stamped pottery produced by the seafaring Lapita culture, whose makers were ancestors of the Polynesians."),
    ("Fijian Tabua (Whale's Tooth)", "Tabua", "Fijian people", "Traditional", "Fiji", "A polished sperm whale tooth exchanged as a treasured ceremonial object central to Fijian social and diplomatic customs."),
    ("Kula Ring Shell Valuables", "Kula ring", "Trobriand Islanders", "Traditional", "Papua New Guinea", "Shell armbands and necklaces exchanged in a ceremonial network linking island communities of the Massim archipelago."),
    ("Asmat Bisj Ancestor Poles", "Bisj pole", "Asmat people", "Traditional", "Indonesia (Papua)", "Towering carved wooden poles honoring deceased ancestors, created by the Asmat people of New Guinea as part of ritual ceremonies."),
    ("Sepik River Ancestor Masks", "Sepik", "Sepik River peoples", "Traditional", "Papua New Guinea", "Elaborately carved wooden masks and spirit figures produced by the diverse riverine cultures of the Sepik basin."),
    ("Malagan Funerary Carvings", "Malagan (art)", "New Ireland peoples", "Traditional", "Papua New Guinea", "Intricately carved and painted wooden sculptures created for elaborate funerary ceremonies on the island of New Ireland."),
    ("Uli Ancestor Figures", "Uli figure", "New Ireland peoples", "Traditional", "Papua New Guinea", "Powerful carved wooden figures combining male and female attributes, used in New Ireland fertility and warfare rituals."),
    ("Rongorongo Tablets", "Rongorongo", "Rapa Nui people", "18th-19th century (script possibly older)", "Easter Island (Chile)", "An undeciphered glyphic script carved onto wooden tablets by the Rapa Nui people, one of only a handful of independently invented writing systems."),
    ("Tangata Manu Birdman Petroglyphs", "Tangata manu", "Rapa Nui people", "c. 1760-1878 AD", "Easter Island (Chile)", "Carved petroglyphs at Orongo village associated with the Rapa Nui birdman cult and its annual ritual competition."),
    ("Marquesan Stone Tiki", "Tiki", "Marquesan people", "Traditional", "French Polynesia", "Monumental stone ancestor and deity figures carved by Marquesan sculptors, among the most powerful stone sculptures of Polynesia."),
    ("Tafuliae Shell Money", "Tafuliae", "Langalanga people", "Traditional", "Solomon Islands", "Strings of polished shell discs manufactured and used as currency and bride-wealth among the peoples of the Solomon Islands."),
    ("Maori Waka Huia Treasure Box", "Waka huia", "Māori", "Traditional", "New Zealand", "An elaborately carved suspended box used by Māori chiefs to store treasured feathers and ornaments."),
    ("Rarotongan Staff God", "Staff god", "Cook Islanders", "18th-19th century", "Cook Islands", "A long carved wooden staff topped with a small figure and wrapped in bark cloth, representing a major deity of the Cook Islands."),
    ("Hawaiian Kii Temple Images", "Kiʻi", "Native Hawaiians", "Traditional", "Hawaii (United States)", "Carved wooden images of gods placed in Hawaiian temple enclosures (heiau) as objects of ritual veneration."),
    ("A'a Figure of Rurutu", "A'a (deity)", "Austral Islanders", "c. 18th century", "French Polynesia", "A wooden ancestor figure covered in smaller carved figures, considered one of the masterworks of Polynesian sculpture."),
    ("Nan Madol Megalithic City", "Nan Madol", "Saudeleur dynasty", "c. 1180-1200 AD onward", "Micronesia (Pohnpei)", "A vast complex of artificial islets built from massive basalt logs, sometimes called the 'Venice of the Pacific'."),
    ("Yap Stone Money (Rai Stones)", "Rai stones", "Yapese people", "c. 500-1900 AD", "Micronesia (Yap)", "Massive carved limestone discs used as a traditional form of currency on the island of Yap, some weighing several tons."),

    # --- Andean and Mesoamerican beyond the most obvious pieces ---
    ("Inca Quipu Recording Device", "Quipu", "Inca Empire", "c. 13th-16th century AD", "Peru", "A system of knotted, colored strings used by the Inca to record numerical and possibly narrative information without a written script."),
    ("Coricancha Golden Temple Remains", "Coricancha", "Inca Empire", "15th century AD", "Peru", "The principal Inca temple of the sun in Cusco, once famously sheathed in gold plates before being plundered by Spanish conquistadors."),
    ("Andean Ceremonial Tumi Knife", "Tumi", "Various pre-Columbian Andean cultures (Chimu/Lambayeque)", "c. 900-1470 AD", "Peru", "A crescent-bladed ceremonial knife, often cast in gold, used in Andean ritual sacrifice and now an emblem of Peruvian heritage."),
    ("Mummy Juanita, the Ice Maiden of Ampato", "Mummy Juanita", "Inca Empire", "c. 1450-1480 AD", "Peru", "The remarkably preserved frozen remains of a young girl ritually sacrificed atop Mount Ampato as an offering to the Inca gods."),
    ("Llullaillaco Maiden", "Llullaillaco maiden", "Inca Empire", "c. 1500 AD", "Argentina", "One of three remarkably preserved child mummies found near the summit of Volcan Llullaillaco, sacrificed in the Inca capacocha ritual."),
    ("Karajia Sarcophagi", "Karajía", "Chachapoya culture", "c. 15th century AD", "Peru", "Anthropomorphic clay sarcophagi mounted on a cliff face, housing the mummified remains of Chachapoya elite."),
    ("Laguna de los Condores Mummies", "Laguna de los Cóndores", "Chachapoya culture", "c. 15th century AD", "Peru", "A remote cliffside mausoleum where hundreds of Chachapoya mummy bundles and textiles were discovered in 1996."),
    ("Tomb Treasures of the Lord of Sipan", "Lord of Sipán", "Moche culture", "c. 3rd century AD", "Peru", "The unlooted royal tomb of a Moche warrior-priest, yielding some of the richest pre-Columbian gold and turquoise regalia ever found."),
    ("Moche Portrait Stirrup-Spout Vessel", "Moche culture", "Moche culture", "c. 100-700 AD", "Peru", "Finely modeled ceramic vessels depicting individualized human portraits, among the most naturalistic pottery traditions of the ancient Americas."),
    ("Huaca de la Luna", "Huaca de la Luna", "Moche culture", "c. 100-700 AD", "Peru", "A stepped adobe pyramid temple decorated with vividly painted polychrome friezes of Moche deities and ritual scenes."),
    ("Huaca del Sol", "Huaca del Sol", "Moche culture", "c. 100-700 AD", "Peru", "Once the largest adobe brick structure in the Americas, built as the ceremonial and administrative center of the Moche state."),
    ("Sican Lord's Gold Funerary Mask", "Sicán culture", "Sicán (Lambayeque) culture", "c. 900-1100 AD", "Peru", "Elaborate gold funerary masks and regalia produced by the Sican culture, reflecting one of the ancient Andes' most prolific goldworking traditions."),
    ("Nazca Polychrome Ceramics", "Nazca culture", "Nazca culture", "c. 100 BC - 800 AD", "Peru", "Vividly painted multicolor pottery depicting deities, animals, and plants, produced by the culture famed for the Nazca Lines."),
    ("Cahuachi Ceremonial Center", "Cahuachi", "Nazca culture", "c. 1-500 AD", "Peru", "The principal ceremonial pilgrimage center of the Nazca culture, comprising numerous earthen mounds and plazas."),
    ("The Lanzon of Chavin de Huantar", "Lanzón", "Chavín culture", "c. 900-200 BC", "Peru", "A great carved granite deity image standing at the heart of the Chavin temple, believed to be an oracle of a fanged supreme god."),
    ("Tello Obelisk", "Tello Obelisk", "Chavín culture", "c. 900-200 BC", "Peru", "An intricately carved granite monolith depicting caiman deities, one of the finest examples of Chavin stone-carving art."),
    ("Raimondi Stele", "Raimondi Stele", "Chavín culture", "c. 900-200 BC", "Peru", "A large carved granite slab depicting a staff-bearing deity, celebrated for its complex, reversible iconography."),
    ("Paracas Culture Artifacts", "Paracas culture", "Paracas culture", "c. 800 BC - 100 AD", "Peru", "An early Andean culture renowned for advanced cranial trepanation surgery and elaborate funerary bundles."),
    ("Gateway of the Sun", "Gateway of the Sun", "Tiwanaku Empire", "c. 500-1000 AD", "Bolivia", "A monolithic stone gateway carved with a central deity figure, among the most significant monuments of the Tiwanaku civilization."),
    ("Ponce Monolith", "Ponce Monolith", "Tiwanaku Empire", "c. 500-1000 AD", "Bolivia", "A large carved sandstone statue standing at the center of the Kalasasaya temple enclosure at Tiwanaku."),
    ("Bennett Monolith", "Bennett Monolith", "Tiwanaku Empire", "c. 500-1000 AD", "Bolivia", "One of the largest and most elaborately carved standing stone statues of the Tiwanaku civilization."),
    ("Wari Culture Ceremonial Vessels", "Wari culture", "Wari Empire", "c. 600-1000 AD", "Peru", "Finely crafted polychrome ceramics and tapestries produced by the Wari, the Andes' first expansive imperial civilization."),
    ("Bonampak Murals", "Bonampak", "Maya civilization", "c. 790 AD", "Mexico", "A Maya site whose interior walls preserve the most complete surviving cycle of ancient Maya narrative murals, depicting war and ritual."),
    ("Sarcophagus of K'inich Janaab' Pakal", "Sarcophagus of K'inich Janaab' Pakal", "Maya civilization", "7th century AD", "Mexico", "A massive carved stone sarcophagus lid depicting the Palenque ruler's descent into the underworld, found within the Temple of the Inscriptions."),
    ("Red Queen of Palenque", "Red Queen (Palenque)", "Maya civilization", "7th century AD", "Mexico", "The cinnabar-covered remains of a Maya noblewoman found in a tomb adjacent to Pakal's, adorned with a jade funerary mask and jewelry."),
    ("Leiden Plaque", "Leiden Plaque", "Maya civilization", "320 AD", "Guatemala", "An early inscribed jade plaque bearing one of the oldest deciphered Long Count dates in Maya writing."),
    ("Chac Mool Reclining Figure", "Chac Mool", "Toltec and Maya civilizations", "c. 9th-15th century AD", "Mexico", "A recurring Mesoamerican sculptural form of a reclining figure holding a bowl on its abdomen, associated with ritual offerings."),
    ("Classic Maya Painted Ceramics", "Maya ceramics", "Maya civilization", "c. 250-900 AD", "Mexico/Guatemala/Belize", "Finely painted polychrome vessels depicting courtly life and mythology, among the richest pictorial records of the Classic Maya world."),
    ("Aztec Sun Stone (Piedra del Sol)", "Aztec sun stone", "Aztec (Mexica) Empire", "c. 1502-1521 AD", "Mexico", "A massive carved basalt monolith depicting Aztec cosmology and the calendar, among the most iconic objects of Mesoamerican art."),
    ("Coatlicue Statue", "Coatlicue", "Aztec (Mexica) Empire", "c. 15th century AD", "Mexico", "A monumental basalt statue of the Aztec earth goddess, depicted with a skirt of writhing serpents and a necklace of hearts and hands."),
    ("Coyolxauhqui Stone", "Coyolxauhqui Stone", "Aztec (Mexica) Empire", "late 15th century AD", "Mexico", "A massive carved disk depicting the dismembered moon goddess, discovered in 1978 and leading to the excavation of the Templo Mayor."),
    ("Aztec Turquoise Double-Headed Serpent", "Double-headed serpent (Aztec)", "Aztec (Mexica) or Mixtec artisans", "15th-16th century AD", "Mexico", "A wooden sculpture entirely covered in turquoise mosaic, believed to have been worn as a ceremonial breastplate."),
    ("Teocalli of Sacred Warfare", "Teocalli of Sacred Warfare", "Aztec (Mexica) Empire", "early 16th century AD", "Mexico", "A carved stone throne shaped like a miniature temple, commemorating Aztec military and cosmological ideology."),
    ("Stone of Tizoc", "Stone of Tizoc", "Aztec (Mexica) Empire", "c. 1480s AD", "Mexico", "A large carved cylindrical stone depicting the Aztec ruler Tizoc's military conquests, likely used for gladiatorial sacrifice."),
    ("Aztec Eagle Warrior Sculpture", "Eagle Warrior", "Aztec (Mexica) Empire", "late 15th century AD", "Mexico", "Life-sized ceramic sculptures representing members of the elite Aztec eagle warrior military order."),
    ("Tlaltecuhtli Monolith", "Tlaltecuhtli", "Aztec (Mexica) Empire", "1502 AD", "Mexico", "A massive carved relief of the Aztec earth deity, discovered in 2006 near the Templo Mayor and depicting the reigning emperor's accession."),
    ("Olmec Colossal Heads", "Olmec colossal heads", "Olmec civilization", "c. 1200-900 BC", "Mexico", "Enormous carved basalt portrait heads of Olmec rulers, among the earliest and most monumental sculptures of ancient Mesoamerica."),
    ("Olmec Ceremonial Altars of La Venta", "La Venta", "Olmec civilization", "c. 900-400 BC", "Mexico", "The principal ceremonial center of the Olmec civilization, notable for massive carved stone altars and colossal heads."),
    ("Kunz Axe", "Kunz Axe", "Olmec civilization", "c. 1000-400 BC", "Mexico", "A large ceremonial jade axe carved in the form of a were-jaguar deity, among the finest examples of Olmec lapidary art."),
    ("Las Limas Monument (Were-Jaguar Figure)", "Las Limas Monument 1", "Olmec civilization", "c. 1000-600 BC", "Mexico", "A greenstone statue of a youth holding a were-jaguar infant, considered a key icon for interpreting Olmec religious iconography."),
    ("Zapotec Funerary Urns", "Zapotec civilization", "Zapotec civilization", "c. 500 BC - 800 AD", "Mexico", "Elaborately modeled effigy urns representing deities and ancestors, placed in Zapotec tombs at Monte Alban."),
    ("Danzantes of Monte Alban", "Danzantes (Monte Albán)", "Zapotec civilization", "c. 500-300 BC", "Mexico", "Carved stone slabs depicting contorted human figures, among the earliest known monumental relief sculptures in Mesoamerica."),
    ("Tomb 7 Mixtec Gold Treasure", "Tomb 7 (Monte Albán)", "Mixtec civilization", "c. 1350-1500 AD", "Mexico", "A reused Zapotec tomb where the Mixtec buried a ruler with the richest cache of pre-Columbian gold and jewelry ever found in the Americas."),

    # --- Middle East beyond Egypt: Persia/Iran, the Levant, Yemen, Oman ---
    ("Cyrus Cylinder", "Cyrus Cylinder", "Achaemenid Persian Empire", "539 BC", "Iran", "A clay cylinder inscribed with a proclamation of Cyrus the Great, sometimes described as an early charter of human rights."),
    ("Apadana Reliefs of Persepolis", "Apadana", "Achaemenid Persian Empire", "c. 515 BC", "Iran", "The grand audience hall of Persepolis, whose staircases are carved with processions of tribute-bearing delegations from across the Persian Empire."),
    ("Behistun Inscription", "Behistun Inscription", "Achaemenid Persian Empire", "c. 522-486 BC", "Iran", "A monumental trilingual rock relief and inscription of Darius the Great, crucial to the decipherment of cuneiform script."),
    ("Lamassu Guardian Figures", "Lamassu", "Ancient Near Eastern civilizations", "c. 9th-6th century BC", "Iran/Mesopotamia", "Colossal winged, human-headed bulls or lions that guarded the gates of ancient Near Eastern palaces."),
    ("Persepolis Fortification Archive", "Persepolis Fortification Archive", "Achaemenid Persian Empire", "c. 509-493 BC", "Iran", "Thousands of clay administrative tablets recording the daily workings of the Achaemenid imperial economy."),
    ("Tomb of Cyrus the Great", "Tomb of Cyrus the Great", "Achaemenid Persian Empire", "c. 530 BC", "Iran", "The relatively simple stone tomb of the founder of the Persian Empire, standing at Pasargadae."),
    ("Naqsh-e Rustam Royal Tombs", "Naqsh-e Rustam", "Achaemenid and Sasanian Persian Empires", "5th century BC - 4th century AD", "Iran", "A necropolis of monumental rock-cut tombs and reliefs of Achaemenid and Sasanian kings carved into a cliff face."),
    ("Achaemenid Gold Rhyton", "Rhyton", "Achaemenid Persian Empire", "c. 5th century BC", "Iran", "Horn-shaped ceremonial drinking vessels, often crafted in gold and terminating in the forepart of a winged beast."),
    ("Ziggurat and Sanctuary of Chogha Zanbil", "Chogha Zanbil", "Elamite civilization", "c. 1250 BC", "Iran", "One of the few surviving ziggurats outside Mesopotamia, built by the Elamite king Untash-Napirisha to honor the god Inshushinak."),
    ("Frieze of Archers", "Frieze of Archers", "Achaemenid Persian Empire", "5th century BC", "Iran", "A glazed brick relief depicting the Persian royal guard, excavated from the palace of Darius I at Susa."),
    ("Sasanian Royal Silver Hunting Plate", "Sasanian art", "Sasanian Empire", "c. 3rd-7th century AD", "Iran", "Silver plates embossed with royal hunting scenes, exemplifying the refined court art of the Sasanian dynasty."),
    ("Naqsh-e Rajab Reliefs", "Naqsh-e Rajab", "Sasanian Empire", "3rd century AD", "Iran", "A group of rock-cut reliefs depicting the investiture and triumphs of early Sasanian kings."),
    ("Cameo of Shapur I", "Cameo of Shapur I", "Sasanian Empire", "3rd century AD", "Iran", "A carved gem depicting the Sasanian king Shapur I triumphing on horseback over the captured Roman emperor Valerian."),
    ("Pasargadae Royal Garden Complex", "Pasargadae", "Achaemenid Persian Empire", "6th century BC", "Iran", "The first capital of the Achaemenid Empire, founded by Cyrus the Great and home to one of the earliest known formal royal gardens."),
    ("Gate of All Nations", "Gate of All Nations", "Achaemenid Persian Empire", "c. 480s BC", "Iran", "The monumental gateway to Persepolis, guarded by colossal stone lamassu figures and inscribed by Xerxes I."),
    ("Ziwiye Hoard", "Ziwiye hoard", "Median/Scythian-influenced culture", "c. 7th century BC", "Iran", "A rich cache of gold and ivory objects blending Assyrian, Scythian, and local styles, discovered in Iranian Kurdistan."),
    ("Marlik Gold and Silver Vessels", "Marlik", "Marlik culture", "c. 1400-1000 BC", "Iran", "A Bronze Age necropolis in northern Iran that yielded finely worked gold and silver vessels depicting animals and mythical beasts."),
    ("Hasanlu Gold Bowl", "Hasanlu Gold Bowl", "Unknown (Hasanlu culture)", "c. 1250-800 BC", "Iran", "A richly embossed gold bowl decorated with mythological scenes, discovered in the burned ruins of the ancient citadel of Hasanlu."),
    ("Chogha Mish Prehistoric Settlement", "Chogha Mish", "Unknown (prehistoric Iran)", "c. 6800-4400 BC", "Iran", "One of the oldest known prehistoric settlements in the Near East, providing key evidence for the origins of complex society in Iran."),
    ("Tepe Sialk Ziggurat and Necropolis", "Tepe Sialk", "Unknown (prehistoric Iran)", "c. 5500-3000 BC", "Iran", "An ancient settlement mound near Kashan containing one of Iran's earliest ziggurats and richly furnished prehistoric graves."),
    ("Arjan Bowl", "Arjan bowl", "Neo-Elamite civilization", "c. 7th-6th century BC", "Iran", "An inscribed bronze bowl found in a rich Elamite tomb, decorated with concentric bands of animals and courtly scenes."),
    ("Ain Ghazal Statues", "ʿAin Ghazal", "Pre-Pottery Neolithic culture", "c. 7200-6250 BC", "Jordan", "Among the oldest large-scale human statues ever made, plastered lime figures crafted by an early Neolithic farming community."),
    ("Mesha Stele (Moabite Stone)", "Mesha Stele", "Kingdom of Moab", "c. 840 BC", "Jordan", "An inscribed basalt stele recording King Mesha of Moab's military victories, one of the earliest major Semitic inscriptions."),
    ("Tel Dan Stele", "Tel Dan stele", "Aramean kingdom", "c. 9th century BC", "Levant (Israel)", "A fragmentary Aramaic victory inscription bearing the earliest known extra-biblical reference to the 'House of David'."),
    ("Siloam Inscription", "Siloam inscription", "Kingdom of Judah", "c. 700 BC", "Levant (Jerusalem)", "A Hebrew inscription commemorating the completion of King Hezekiah's water tunnel beneath ancient Jerusalem."),
    ("Lachish Reliefs", "Lachish reliefs", "Neo-Assyrian Empire", "c. 700 BC", "Levant (Israel)", "Detailed palace reliefs depicting the Assyrian siege and conquest of the Judahite city of Lachish."),
    ("Ahiram Sarcophagus", "Ahiram Sarcophagus", "Phoenician civilization (Byblos)", "c. 1000 BC", "Lebanon", "A carved limestone sarcophagus bearing one of the earliest known inscriptions in the Phoenician alphabet."),
    ("Ugaritic Cuneiform Alphabet Tablets", "Ugarit", "Ugaritic civilization", "c. 14th-12th century BC", "Syria", "An ancient Levantine city whose archives preserved the world's earliest known alphabetic cuneiform script and Canaanite mythological texts."),
    ("Qumran Caves", "Qumran Caves", "Second Temple-era Jewish community", "c. 3rd century BC - 1st century AD", "Levant (West Bank)", "A cluster of caves near the Dead Sea where ancient manuscript scrolls were discovered hidden in ceramic jars."),
    ("Tell es-Sultan (Ancient Jericho)", "Tell es-Sultan", "Pre-Pottery Neolithic culture", "c. 9000 BC onward", "Levant (West Bank)", "The archaeological mound of Jericho, containing evidence of what may be the oldest known walled settlement in the world."),
    ("Tel Megiddo", "Tel Megiddo", "Canaanite and Israelite civilizations", "c. 3000 BC - 400 BC", "Levant (Israel)", "A strategically vital ancient tel with over twenty superimposed layers of settlement, associated with the biblical Armageddon."),
    ("Beit She'an Ruins", "Beit She'an", "Canaanite, Egyptian, and Roman-Byzantine civilizations", "c. 3rd millennium BC - 8th century AD", "Levant (Israel)", "A multi-layered archaeological tel and Roman-Byzantine city renowned for its exceptionally well-preserved colonnaded streets."),
    ("Khirbet Qeiyafa Fortress", "Khirbet Qeiyafa", "Kingdom of Judah", "c. 1020-980 BC", "Levant (Israel)", "An early fortified Judahite site that yielded one of the oldest known Hebrew inscriptions, the Qeiyafa Ostracon."),
    ("Great Dam of Marib", "Marib Dam", "Sabaean Kingdom", "c. 8th century BC", "Yemen", "An ancient engineering marvel that irrigated the Sabaean kingdom for over a millennium, celebrated in Yemeni and Islamic tradition."),
    ("Sabaean Kingdom Inscriptions", "Sabaeans", "Sabaean Kingdom", "c. 8th century BC - 3rd century AD", "Yemen", "Monumental South Arabian inscriptions documenting the trade, religion, and governance of the ancient incense-trading kingdom of Saba."),
    ("Awam Temple (Bar'an Temple)", "Awam Temple", "Sabaean Kingdom", "c. 7th century BC", "Yemen", "A grand oval temple dedicated to the moon god Almaqah, one of the most important religious sites of ancient Sabaean Yemen."),
    ("Baraqish Ancient City Walls", "Baraqish", "Minaean Kingdom", "c. 1st millennium BC", "Yemen", "The well-preserved fortified city of ancient Yathill, capital of the Minaean kingdom on Yemen's incense trade route."),
    ("Zafar, Capital of the Himyarite Kingdom", "Zafar, Yemen", "Himyarite Kingdom", "c. 1st century BC - 6th century AD", "Yemen", "The mountaintop capital of the Himyarite kingdom, which came to dominate South Arabia's lucrative incense trade."),
    ("Bat, Al-Khutm and Al-Ayn Bronze Age Tombs", "Bat, Al-Khutm and Al-Ayn", "Umm an-Nar culture", "c. 3000-2000 BC", "Oman", "A necropolis of monumental beehive-shaped stone tombs and towers, among the best-preserved Bronze Age sites of the Arabian Peninsula."),
    ("Land of Frankincense Sites", "Land of Frankincense", "Ancient South Arabian trading kingdoms", "c. 4th century BC - 8th century AD", "Oman", "Caravan oases, ports, and frankincense groves that anchored one of history's most lucrative ancient trade networks."),
    ("Sumhuram (Khor Rori) Port City", "Sumhuram", "Kingdom of Hadhramaut", "1st century AD", "Oman", "A fortified ancient port city that shipped frankincense across the Indian Ocean, excavated with inscriptions and imported artifacts."),
]
CATEGORY_ASSIGNMENTS.append((MORE_ARCHAEOLOGY_BATCH2, "archaeology"))
